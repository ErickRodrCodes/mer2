...
export const setupWindowLogger = (mainWindow: BrowserWindow) => {
  ...
  mainWindow.webContents.on('render-process-gone', (_event, details) => {
    ...
    dialog.showMessageBox(mainWindow, {
      ...
      message:
        'The Renderer process was lost and cannot be restored. Please check the logs for more details:\n' +
        logFilePath,
    });
  });
  ...
  process.on('uncaughtException', (error) => {
    ...
    dialog.showMessageBox(mainWindow, {
      ...
      title: 'Application Error',
      message:
        'An uncaught exception occurred in the application. Please check the logs for more details:\n' +
        logFilePath,
    });
  });
  ...
  process.on('unhandledRejection', (reason, promise) => {
    ...
    dialog.showMessageBox(mainWindow, {
      ...
      title: 'Application Error',
      message:
        'An unhandled promised rejection occuried in the application. please check the logs for more details:\n' +
        logFilePath,
    });
  });
};
